...
#define shfitMask ShiftMask
#define ctrlMask ControlMask
#define comb (ctrlMask|shfitMask)
 ...
 */
static uint forcemousemod = shfitMask;
...
static MouseShortcut mshortcuts[] = {
    ...
    {shfitMask, Button4, kscrollup, {.i = 1}},
    {shfitMask, Button5, kscrolldown, {.i = 1}},
...
static Shortcut shortcuts[] = {
    ...
    {shfitMask, XK_Print, printscreen, {.i = 0}},
    ...
    {shfitMask, XK_Insert, selpaste, {.i = 0}},

    {comb, XK_Num_Lock, numlock, {.i = 0}},

    {shfitMask, XK_Page_Up, kscrollup, {.i = -1}},
    {shfitMask, XK_Page_Down, kscrolldown, {.i = -1}},
...
static Key key[] = {
    ...
    {XK_KP_Home, shfitMask, "\033[2J", 0, -1},
    {XK_KP_Home, shfitMask, "\033[1;2H", 0, +1},
    ...
    {XK_KP_Prior, shfitMask, "\033[5;2~", 0, 0},
    {XK_KP_Prior, XK_ANY_MOD, "\033[5~", 0, 0},
    {XK_KP_Begin, XK_ANY_MOD, "\033[E", 0, 0},
    {XK_KP_End, ctrlMask, "\033[J", -1, 0},
    {XK_KP_End, ctrlMask, "\033[1;5F", +1, 0},
    {XK_KP_End, shfitMask, "\033[K", -1, 0},
    {XK_KP_End, shfitMask, "\033[1;2F", +1, 0},
    {XK_KP_End, XK_ANY_MOD, "\033[4~", 0, 0},
    {XK_KP_Next, shfitMask, "\033[6;2~", 0, 0},
    {XK_KP_Next, XK_ANY_MOD, "\033[6~", 0, 0},
    {XK_KP_Insert, shfitMask, "\033[2;2~", +1, 0},
    {XK_KP_Insert, shfitMask, "\033[4l", -1, 0},
    ...
    {XK_KP_Delete, shfitMask, "\033[2K", -1, 0},
    {XK_KP_Delete, shfitMask, "\033[3;2~", +1, 0},
    ...
    {XK_Up, shfitMask, "\033[1;2A", 0, 0},
    {XK_Up, altMask, "\033[1;3A", 0, 0},
    {XK_Up, shfitMask | altMask, "\033[1;4A", 0, 0},
    {XK_Up, ctrlMask, "\033[1;5A", 0, 0},
    {XK_Up, shfitMask | ctrlMask, "\033[1;6A", 0, 0},
    {XK_Up, ctrlMask | altMask, "\033[1;7A", 0, 0},
    {XK_Up, shfitMask | ctrlMask | altMask, "\033[1;8A", 0, 0},
    {XK_Up, XK_ANY_MOD, "\033[A", 0, -1},
    {XK_Up, XK_ANY_MOD, "\033OA", 0, +1},
    {XK_Down, shfitMask, "\033[1;2B", 0, 0},
    {XK_Down, altMask, "\033[1;3B", 0, 0},
    {XK_Down, shfitMask | altMask, "\033[1;4B", 0, 0},
    {XK_Down, ctrlMask, "\033[1;5B", 0, 0},
    {XK_Down, shfitMask | ctrlMask, "\033[1;6B", 0, 0},
    {XK_Down, ctrlMask | altMask, "\033[1;7B", 0, 0},
    {XK_Down, shfitMask | ctrlMask | altMask, "\033[1;8B", 0, 0},
    {XK_Down, XK_ANY_MOD, "\033[B", 0, -1},
    {XK_Down, XK_ANY_MOD, "\033OB", 0, +1},
    {XK_Left, shfitMask, "\033[1;2D", 0, 0},
    {XK_Left, altMask, "\033[1;3D", 0, 0},
    {XK_Left, shfitMask | altMask, "\033[1;4D", 0, 0},
    {XK_Left, ctrlMask, "\033[1;5D", 0, 0},
    {XK_Left, shfitMask | ctrlMask, "\033[1;6D", 0, 0},
    {XK_Left, ctrlMask | altMask, "\033[1;7D", 0, 0},
    {XK_Left, shfitMask | ctrlMask | altMask, "\033[1;8D", 0, 0},
    {XK_Left, XK_ANY_MOD, "\033[D", 0, -1},
    {XK_Left, XK_ANY_MOD, "\033OD", 0, +1},
    {XK_Right, shfitMask, "\033[1;2C", 0, 0},
    {XK_Right, altMask, "\033[1;3C", 0, 0},
    {XK_Right, shfitMask | altMask, "\033[1;4C", 0, 0},
    {XK_Right, ctrlMask, "\033[1;5C", 0, 0},
    {XK_Right, shfitMask | ctrlMask, "\033[1;6C", 0, 0},
    {XK_Right, ctrlMask | altMask, "\033[1;7C", 0, 0},
    {XK_Right, shfitMask | ctrlMask | altMask, "\033[1;8C", 0, 0},
    {XK_Right, XK_ANY_MOD, "\033[C", 0, -1},
    {XK_Right, XK_ANY_MOD, "\033OC", 0, +1},
    {XK_ISO_Left_Tab, shfitMask, "\033[Z", 0, 0},
    {XK_Return, altMask, "\033\r", 0, 0},
    {XK_Return, XK_ANY_MOD, "\r", 0, 0},
    {XK_Insert, shfitMask, "\033[4l", -1, 0},
    {XK_Insert, shfitMask, "\033[2;2~", +1, 0},
